...
public class ServicesUI {
    ...
    void RegisterNormalService() {
        ...
        this.shopUI.getWorkers_facade().registerBudgetRequest(new Service(nif, equipment_name, shopUI.getUsername()));    //TODO CUIDADO COUNTERID
    ...
    private void ConsultBudgetByNif() throws IOException, ClassNotFoundException {
        ...
        // Procura
        List<Budget> budgets = this.shopUI.getWorkers_facade().getBudgetbyNif(nif);
    ...
    private void change_preco_budget(Budget b) {
        ...
        shopUI.getWorkers_facade().update_budget(b, new_price, b.getTodo(), b.getStatus());
        clearview();
    }
    ...
    private void change_passos_budget(Budget b) {
        ...
        shopUI.getWorkers_facade().update_budget(b, b.getFinalPrice(), new_passos, b.getStatus());
        shopUI.getWorkers_facade().view_passos(b);
    }
    ...
    private void change_estado_budget(Budget b, List<Budget> budgets) throws IOException, ClassNotFoundException {
        ...
        shopUI.getWorkers_facade().update_budget(b, b.getFinalPrice(), b.getTodo(), BudgetStatus.getStatus(choice));
    }
    ...
    private void ConsultBudget(BudgetStatus budgetStatus) {
        ...
        List<Budget> budgets;
        budgets = new ArrayList<>(shopUI.getWorkers_facade().getBudgetRequestsbyStatus(budgetStatus).values()); //TODO CLONE!!!!!!!
    ...
    private void ConsultExpressServices() {
        ...
        clearview();
        List<Object> objects = shopUI.getWorkers_facade().consultExpressServices();
    ...
    private void ConsultExpressService() throws IOException, ClassNotFoundException {
        ...
        int size = shopUI.getWorkers_facade().numberOfExpressServices();
        ...
        ExpressRepair express = shopUI.getWorkers_facade().getExpressService(op);
    ...
    private void RegisterExpressService(ExpressRepair er) {
        ...
        shopUI.getWorkers_facade().registerBudgetRequest(new Service(nif, equipment_name, shopUI.getUsername(), er));
        System.out.println("New register made for nif [" + nif + "]");
        shopUI.pause();
        clearview();
    }
    ...
    private void Payment(){
        ...
        if(budgetList != null && budgetList.size() > 0) {
            ...
            this.shopUI.getWorkers_facade().updateBudgetStatus(b, BudgetStatus.DELIVERED);
